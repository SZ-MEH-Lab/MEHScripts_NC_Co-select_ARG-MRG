# This is the random forest classification script for classifying samples of unknown information to NOF group and OF group. 

# Usage:
First, install R v4.3.1 and Rstudio in advance. 
